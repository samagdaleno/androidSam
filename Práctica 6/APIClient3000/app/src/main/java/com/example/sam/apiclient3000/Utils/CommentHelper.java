...
public class CommentHelper {
    ...
    public Comments addComment(String id, String body, String email, String postid, String name){
        ...
        Cursor cursor = database.query(DBUtils.COMMENTS_TABLE_NAME,
                ...
                DBUtils.COMMENTS_ID+" = " + lCustomerID, null, null, null, null);
        cursor.moveToFirst();
    ...
    public ArrayList<Comments> getAllComments(){
        ...
        Cursor cursor = database.query(DBUtils.COMMENTS_TABLE_NAME, COMMENTS_TABLE_COLUMNS, null, null, null, null, null, null);
