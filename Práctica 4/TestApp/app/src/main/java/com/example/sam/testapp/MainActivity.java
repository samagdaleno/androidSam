    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_ListView.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                int arraysize = MySingleton.getInstance().getMovies().size() + 1;
                String arrt = Integer.toString(arraysize);

                Toast.makeText(getApplicationContext(), "Tamaño de arreglo: " + arrt, Toast.LENGTH_LONG).show();
                ...
                MySingleton.getInstance().getMovies().add(oMovie);
